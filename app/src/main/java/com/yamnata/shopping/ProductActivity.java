...
public class ProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(singleProduct != null){
            ...
            productSize.setText("Taille: " + String.valueOf(singleProduct.getProductSize()));
            productColor.setText("Couleur: " + singleProduct.getProductColor());
            productPrice.setText("Prix: " + String.valueOf(new Double(singleProduct.getProductPrice()).intValue()) + " euro");
            productDescription.setText(Html.fromHtml("<strong>Description Produit</strong><br/>" + singleProduct.getProductDescription()));
        }
